...
import type { AAVEV3Module, AAVEV3ModuleInterface } from "../AAVEV3Module";
...
type AAVEV3ModuleConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AAVEV3ModuleConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AAVEV3Module__factory extends ContractFactory {
  constructor(...args: AAVEV3ModuleConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): AAVEV3Module__factory {
    return super.connect(runner) as AAVEV3Module__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AAVEV3ModuleInterface {
    return new Interface(_abi) as AAVEV3ModuleInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AAVEV3Module {
    return new Contract(address, _abi, runner) as unknown as AAVEV3Module;
  }
}
